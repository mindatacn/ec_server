...
import static com.mindata.ecserver.global.constant.Constant.ES_COORDINATE_TYPE_NAME;
import static com.mindata.ecserver.global.constant.Constant.ES_GEO_INDEX_NAME;

/**
 * @author wuwf wrote on 2017/11/28
 */
@Document(indexName = ES_GEO_INDEX_NAME, type = ES_COORDINATE_TYPE_NAME, indexStoreType = "fs", shards = 5, replicas
        = 1,
        refreshInterval = "-1")
